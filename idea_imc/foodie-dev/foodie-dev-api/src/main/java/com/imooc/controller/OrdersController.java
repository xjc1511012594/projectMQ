...
//        CookieUtils.setCookie(request, response, FOODIE_SHOPCART, "", true);
         ...
         headers.setContentType(MediaType.APPLICATION_JSON);//格式
         ...
         if(paymentResult.getStatus()!=200){
            log.error("发生错误 {}",paymentResult.getMsg());
            return IMOOCJSONResult.errorMsg("向支付中心创建订单失败，请联系管理员");
         }
