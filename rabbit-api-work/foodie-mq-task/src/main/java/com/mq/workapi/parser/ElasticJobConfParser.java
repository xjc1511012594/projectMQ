...
import com.mq.workapi.enums.ElasticJobTypeEnum;
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        ...
        try {
            ...
            for (Iterator<Object> it = annotationMap.values().iterator(); it.hasNext(); ) {
                ...
                // 2.添加注册中心
                factory.addConstructorArgValue(this.jobZookeeperProperties);
                // 3.添加LiteJobConfiguration
                factory.addConstructorArgValue(jobConfig);
                // 4.如果有eventTraceRdbDataSource 也要添加
                ...
                // 6.将factory 也就是 SpringJobScheduler注入到Spring容器中
            ...
            log.info("共计启动elastic-job作业数量为：{} 个", annotationMap.values().size());

        } catch (ClassNotFoundException e) {
            log.error("elasticjob启动异常， 系统强制退出", e);
        }
    }
