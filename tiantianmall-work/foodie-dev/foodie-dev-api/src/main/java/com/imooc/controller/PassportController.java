...
public class PassportController {
    ...
    public IMOOCJSONResult usernameIsExist(@RequestParam String username){
        ...
        if(StringUtils.isEmpty(username)){
            return  IMOOCJSONResult.errorMsg("传入的用户名不能为空");
        }
    ...
    {
        //1.参数校验
        if(StringUtils.isEmpty(userBO.getConfirmPassword())
                ||StringUtils.isEmpty(userBO.getUsername())
